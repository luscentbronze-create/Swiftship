...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({ currentTab, onNavigate }) => {
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#0E1116]/95 backdrop-blur-lg border-t border-[#1E232F] px-6 py-2">
      <div className="flex items-center justify-around">
        ...
        >
          ...
          <span className="text-[11px] font-semibold">Track Shipment</span>
        </button>
